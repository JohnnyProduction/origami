...
const autor_2 = require("../model/autor");
describe("routes", () => {
    testing_1.TestCRUDRoute("Autor", autor_2.AutorModel, autor_1.AutorRoute, () => ({
        id: 5545,
        name: "autor name",
        avatar: "some url",
    }), "Autor", ["name", "avatar"]);
    describe("autors", () => {
        ...
        it("Возвращает 404 с ошибкой если автора нет", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield request
                ...
                .get(`${new autor_1.AutorRoute().PATH}/${autorId}`)
        ...
        it("Должен вернуть 404 при обновлении не существующего автора", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield request
                .agent(server.info.uri)
                .put(`${new autor_1.AutorRoute().PATH}/${newAutorData.id}?name=${newAutorData.name}`)
                .expect("Content-Type", /json/)
                .expect(404, JSON.stringify({
                error: {
